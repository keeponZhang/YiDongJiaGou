...
//            hook点找到了
    ...
    public  void hookStartActivity(Context context) {
        //主要原理，动态代理IActivityManager，因为每次启动都会通过进程间通信在ActivityManagerService进行调用
        //动态代理会返回个对象，把ActivityManagerNative的gDefault的mInstance替换掉
...
//            因为是静态变量  所以获取的到的是系统值  hook   伪hook,现在这里已经拿到gDefault对象
...
//        还原 IactivityManager对象  系统对象
            ...
            //这里拿到的是iActivityManager（从field里面拿field）
...
//                      登录  还原  把原有的意图    放到realyIntent
    ...
    class startActivty implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            //调用IActivityManager里面的方法时都会走到这里
...
//                真实的意图 被我隐藏到了  键值对
            ...
            //iActivityManagerObject是ActivityManagerService
