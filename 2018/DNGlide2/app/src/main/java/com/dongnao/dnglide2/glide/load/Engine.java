...
import com.dongnao.dnglide2.glide.cache.ActiveResources;
...
import com.dongnao.dnglide2.glide.request.ResourceCallback;
...
public class Engine implements MemoryCache.ResourceRemovedListener, Resource.ResourceListener,
    ...
    public Engine.LoadStatus load(Object model, int width, int height, ResourceCallback cb) {
